...
def plot_hist_field_gyro_ages(outdir, cache_id, MAXAGE=4000,
    ...
    cc = 'midnightblue' if dropfracshortrot else 'C0'
    ...
    if not dropfracshortrot:
        ...
        custom_lines = [Line2D([0], [0], color='C0', lw=0.5, alpha=0.4),
                        ...
                        Line2D([0], [0], color='midnightblue', lw=1, alpha=1.0)
                        ]
...
def plot_trilegal_comparison(outdir, const_sfr=1):
    ...
    fig, axs = plt.subplots(
        ncols=2, figsize=(4,2), constrained_layout=True
    )
