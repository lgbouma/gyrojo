...
that were
fitted to the slow rotation sequences of the Pleiades \citep{Rebull_2016},
...
across 0.04--2.5\,Gyr, comparable to their quoted precision.
...
the referee correctly noted that this only a comparative test of methods,
rather than an ability to actually recover ground truth \citep[e.g.][]{Aigrain2015}.
...
stars would tend to contaminate the 2.5-3\,Gyr peaks in
Figures~\ref{fig:hist_tgyro} and~\ref{fig:hist_tgyro_mcq}.  This
scenario deserves consideration, given evidence from asteroseismic
rotation periods that has pointed to slowed spin-down rates after
$\approx$4\,Gyr for Sun-like stars
\citep[e.g.][]{vanSaders_2016,2024ApJ...962..138S}.  However, because
the \citeauthor{McQuillan_2014} sample does not include many stars
older than $\approx$4\,Gyr \citep{2022ApJ...937...94M}, this analysis
would argue that the 2.5-3\,Gyr peak cannot be caused by a pile-up of
...
\begin{figure*}[!t]
    ...
    (i.e.~none of bit flags zero through nine raised).
	}
