...
\begin{figure}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.43\textwidth]{st_params_M_G_vs_dr3_bp_rp.pdf}
		}
	
		\vspace{-0.3cm}
		\subfloat{
			\includegraphics[width=0.43\textwidth]{st_params_adopted_logg_vs_adopted_Teff.pdf}
		}
	\end{center}
	\vspace{-0.5cm}
...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.49\textwidth]{prot_teff_Santos19_Santos21_dquality.png}
		}
		\subfloat{
			\includegraphics[width=0.49\textwidth]{koi_mean_prot_teff_koi_X_S19S21dquality_keepgrazing.png}
		}
	\end{center}
	\vspace{-0.5cm}
	\caption{
...
and \citetalias{Santos_2021}.  For a discussion of the work by
...
\begin{figure*}[!t]
	...
	\caption{{\bf Potential impact of unresolved binaries.}   This figure shows
		the same raw (thin blue line) and quality-flag cleaned (``gyro applicable'') distributions
		...
		The thick blue ``5\% binary contamination'' distribution corrects for this possibility by randomly removing
...
\item \added{The youngest stars in the Kepler field (0-0.3\,Gyr)
    are at least  \ratiosfr$\pm$\uncratiosfr\ times rarer than stars 3\,Gyr old. The statistical
    ...
    declining star-formation rate}{modeling expectations (Section~\ref{subsec:trilegal}), and with age distributions derived from} from CMD fitting and white-dwarf
  ...
  \item Rather than expecting $\approx$500 exoplanets younger than one
    ...
    \replaced{implies}{suggests} that we should instead expect $\approx$250.
  %
...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.44\textwidth]{prot_teff_Santos19_Santos21_dquality.png}
		}
		\subfloat{
			\includegraphics[width=0.44\textwidth]{prot_teff_McQuillan2014only_dquality.png}
		}
	\end{center}
	\vspace{-0.6cm}
	\caption{
