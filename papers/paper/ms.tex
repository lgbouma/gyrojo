...
\begin{abstract}
  ...
  the Kepler field \replaced{dropping}{smoothly decreasing} by a factor of \ratiosfr$\pm$\uncratiosfr\
...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.47\textwidth]{prot_teff_Santos19_Santos21_dquality.pdf}
		}
		\subfloat{
			\includegraphics[width=0.47\textwidth]{koi_mean_prot_teff_koi_X_S19S21dquality_keepgrazing.pdf}
		}
	\end{center}
	\vspace{-0.5cm}
	\caption{
...
%	}
  ...
  Section~\ref{subsec:flags})}.  The \replaced{bottom}{middle} row shows
  stars with temperatures of 4400--5400\,K, which \replaced{have more precise
  ages due to their fast spin-down}{often have more precise ages}.  The statistical uncertainty for a
...
And finally, the corrected distributions show closer agreement with SFHs
derived from CMD fitting.
...
These lines of evidence suggest that the peak
in the observed age distribution is not caused by a pile-up of
much older stars with especially lethargic spin-down rates, but that it could be
...
Earth-sized planets \added{such as Kepler-1312~c and Kepler-1561~b }with new ages of only a few hundred million years.  
...
\begin{enumerate}[leftmargin=*,topsep=0pt,itemsep=-1ex,partopsep=1ex,parsep=1ex]
  ...
  \item Rather than being uniform, the age distributions of both the
    ...
    chronology, though with the \added{potential }advantage of better sensitivity for
...
quality of the manuscript.} This work was supported by the Heising-Simons 51~Pegasi~b Fellowship
...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.43\textwidth]{prot_teff_Santos19_Santos21_dquality.pdf}
		}
		\subfloat{
			\includegraphics[width=0.43\textwidth]{prot_teff_McQuillan2014only_dquality.pdf}
		}
	\end{center}
	\vspace{-0.5cm}
	\caption{
