...
\begin{figure*}[!t]
	...
	\caption{{\bf Potential impact of unresolved binaries.}   This figure shows
		...
		\fivepctnuniqstarsantosrotgyroappl\ of \ngyroappllttendays\ ``clean'' rotators with
		$P_{\rm rot}$$<$10\,days could be unresolved $\lesssim$0.5\,AU  binaries (see Section~\ref{subsec:caveats}).
		The thick violet ``5\% binary contamination'' distribution corrects for this possibility by randomly removing
...
stars known to host planets}{each star in our sample}.  We attempted to assess this reliability using
...
in any cluster.  \added{While most of these outliers are known to have bad quality flags, some do not.} 
...
Stars with higher metallicity are thought to have longer convective turnover
times, which may slow their rate of spin-down
	\citep{Amard2020}.
While observational studies of this effect have been suggestive, further work
remains to definitively establish the importance of the effect \citep[e.g.][]{Amard2020b,2024arXiv240500779S}
Nonetheless, based on the theoretical predictions, we flagged stars with known
	spectroscopic $|[{\rm Fe/H}]|$$>$0.3, based on either LAMOST or Keck/HIRES
...
For the rest of the sample, primarily composed of fainter stars,
this means that our quality flags were not sensitive to metallicity outliers.
Based on the metallicity distribution of stars for which we do have spectra,
this 
implies that at most $\approx$5\% of stars in our sample might have $|[{\rm Fe/H}]|$$>$0.3,
with a slight bias toward lower metallicity stars over higher metallicity.
Based on the results by \citet{Claytor2020},  this will be most important
...
and $\approx$$\pm$60$^\circ$ \citep{Snodgrass1990}.
...
our model imposed a $\approx$5-10\% level of intrinsic $P_{\rm rot}$ scatter (perhaps differential-rotation induced)
at old ages.
...
This effect can yield a $\approx$20\% age bias for individual Sun-like stars with ages
...
\citep{vanSaders_2016,2024ApJ...962..138S}, or else that combine both
...
An additional nuance is that even after correcting for effects
that can bias rotational ages, our observed age distribution does not 
directly yield a star formation history: 
particularly for pencil-beam surveys such as Kepler,
kinematic heating of stars in the
thin disk significantly sculpts the stellar (and therefore planetary) age distribution.}
...
\item \added{The youngest stars in the Kepler field (0-0.3\,Gyr)
