...
\begin{abstract}
  ...
  the Kepler field dropping by a factor of \ratiosfr$\pm$\uncratiosfr\
...
The implication for planetary ages can appreciated by querying the NASA Exoplanet Archive
...
However, these surveys have cumulatively discovered a total of $\approx$5{,}000 planets.
...
periods above the M67 sequence, our resulting age constraints are\added{ therefore }
quoted as lower limits.
\added{Finally, we opted to impose a $t_{\rm gyro}$ uncertainty floor of 10\%. 
This seemed warranted given the expected amplitude of differential rotation \citep[e.g.][]{Epstein_2014}, and
given the accuracy with which the absolute cluster age scale is currently known \citep[e.g.][]{Dahm_2015}. }
...
the referee correctly pointed out that this only a comparative test of methods,
...
rate by which the SFR in the Kepler field has decreased, by 7-14\%. }
