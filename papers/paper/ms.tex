...
\begin{abstract}
  ...
  stellar sample.
  We attribute the existence of this ``demographic cliff'' to a
...
\replaced{those studies is their improved accuracy}{these previous studies is their accuracy} at $<$1\,Gyr\added{ (see Figure~\ref{fig:agescalecompone})}.
