...
%main sequence.
\added{{\it Metallicity (bit 10)}---Theoretical models
	...
	However, if true, this effect could cause systematic
...
%	}
  ...
  ages due to their fast spin-down}{have more precise ages}.  The statistical uncertainty for a
...
Relative to the nominal ``gyro applicable'' age distribution, there are three important differences.
...
The rate of decline in star formation
since $\approx$2.8\,Gyr ago is also constant, rather than having a ``kink'' at 1.5\,Gyr.
...
Based on the study by \citet{Claytor2020},  this will be most important
...
and binarity, we expect that up to a third of our ``apparently clean'' 
...
\item \added{The youngest Kepler stars (0-0.3\,Gyr)
  ...
  %
  \item We have \replaced{derived}{reported} rotation-based ages for \nplyounggyrotwosigma\
