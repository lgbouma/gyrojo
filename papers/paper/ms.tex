...
%	}
  ...
  ages due to their fast spin-down}{usually have more precise ages}.  The statistical uncertainty for a
...
\begin{figure}[!t]
  ...
  \caption{
    ...
    raised.}{Transiting systems are selected to have $t$<1\,Gyr at $2$$\sigma$.
    Star symbols denote \nplyounggyrotwosigmanograzingnoruwe\ planets
...
\begin{figure*}[!t]
	...
	\caption{{\bf Impact of star formation rate (SFR) and kinematic heating on age distribution.}   
		Most Kepler stars are a few hundred parsecs above the Galactic plane ($\hat{Z}$ points to the north galactic pole;  $\hat{Y}$ is the direction of
		...
		a decreasing SFR qualitatively match the observed paucity of the youngest stars.
		\label{fig:trilegal}
	}
\end{figure*}
...
increase in stellar velocity dispersions and the disk's vertical 
...
\added{Figure~\ref{fig:trilegal} compares the simulation results against
...
\begin{figure*}[!t]
	...
	\caption{{\bf Potential impact of unresolved binaries.}   This figure shows
		...
		\fivepctnuniqstarsantosrotgyroappl\ out of \ngyroappllttendays\ ``clean'' rotators with
...
\begin{enumerate}[leftmargin=*,topsep=0pt,itemsep=-0.5ex,partopsep=1ex,parsep=1ex]
  ...
  \item Rather than being uniform, the age distributions of both the
    ...
    formation rate today is\added{ at least} \ratiosfr$\pm$\uncratiosfr\ times lower
...
\item \added{The youngest stars in the Kepler field (0-0.3\,Gyr)
    ...
    photometric binaries, which could push it as high as 4.81$\pm$0.26 (Section~\ref{subsec:caveats})}.
     \replaced{This}{Either} result \replaced{from
