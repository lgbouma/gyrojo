...
We imposed no constraint on whether the iodine cell was present, since
...
\subsection{The Sub-Gigayear Sample}
...
For this exercise, we follow Table~\ref{tab:youngplanets}.

\paragraph{The Cep-Her Planets}
Kepler\,1627Ab, Kepler\,1643b, Kepler\,1974b and Kepler\,1975\,Ab are
known members of the $\approx$40\,Myr old Cep-Her association
\citep{Bouma_2022a,Bouma_2022b}.
The age of various sub-components of this association are
best measured through relative isochronal placement of the
pre-main-sequence \citep[see][]{Bouma_2022b}, and gyrochronology of
stars in these clusters show them to be $<$100\,Myr old.
The planets themselves are all on close-in orbits (5-25\,days), with
sizes from 2-4\,$R_\oplus$.
For Kepler\,1627A and Kepler\,1974, the rotation and lithium-based
ages for these stars agree within 1$\sigma$ with the cluster-based
ages.
{\bf TODO discuss Kepler-1643 old tension, ditto KOI7913...}

\paragraph{Theia~520 Planets}

Kepler\,968 and Kepler\,52 both have rotation-based ages near
350\,Myr.
They are also members of Theia~520 (CITE).
Independent work by J.~Curtis et al.~is indicating an age of XXX\,Myr for this
cluster.
This makes them the youngest multiplanet systems that have currently
been identified from the Kepler primary mission.

\paragraph{NGC~6811 Planets}
Meibom (CITE CITE) ... do we get those ones?


\paragraph{Systems with Rotation and Lithium in Agreement}
Kepler\,1529b, a 5.3\,day 2.0\,$R_\oplus$ mini-Neptune is
$\approx$100\,Myr old.

Kepler\,1928b, a 19.6\,day 1.9\,$R_\oplus$ mini-Neptune is
$\approx$140-200\,Myr old.

Kepler\,1930b, a 13.0\,day 1.5\,$R_\oplus$ super-Earth on a grazing
orbit is $\approx$120-180\,Myr old.

Kepler\,1313b, doubly unlucky, a 3.8\,day 1.7\,$R_\oplus$ super-Earth
on a grazing orbit is $\approx$185\,Myr old.

Kepler\,1521b, a 47.2\,day 2.3\,$R_\oplus$ super-Earth is 180-210\,Myr
old.

Kepler\,1467b, a 47.1\,day 3.1\,$R_\oplus$ mini-Neptune is
230-240\,Myr old.

Kepler\,1565b, a 1.5\,day 1.3\,$R_\oplus$ super-Earth is 180-230\,Myr
old.

Kepler\,971b, a 9.6\,day 3.9\,$R_\oplus$ Neptune-sized planet is
300-370\,Myr old.

Kepler\,1933b is a 4.9\,day 1.0\,$R_\oplus$ Earth-sized planet.  Its
rotation-based age of $304^{+96}_{-112}$\,Myr agrees within $1\sigma$
of its lithium age, though at half the relative uncertainty.
This system may be the youngest Earth-sized planet known, comparable to 
systems such as HD~63433d \citep[1.1\,$R_\oplus$, $414\pm23$\,Myr][]{2024AJ....167...54C}.


\paragraph{Other Notables}
...
Kepler~411 is also odd, due to the 58\,day-outer planet.
...
\begin{deluxetable*}{llllrrrrr}
	...
	%\endhead
	\startdata
  KOI & Kepler & $t_{\rm gyro}$ & $t_{\rm Li} $ & $R_{\rm p}$ & $P_{\rm orb}$ & $f_{\rm RUWE}$ & $f_{\rm grazing}$ & Spec? \\
  -- &   -- & Myr & Myr &    Earths &    days &      bool &   bool  & bool \\
	\hline
