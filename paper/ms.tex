...
The comment column of Table~\ref{tab:planets} compares
the independent rotation and lithium ages of the
known planet hosts using the point-estimates of their age posteriors.
There are three cases of interest.
{\it 1i)} If two-sided posteriors for both $t_{\rm gyro}$ and $t_{\rm Li}$ existed,
and their values were consistent within 2$\sigma$, we judged them
