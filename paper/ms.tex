...
\begin{figure*}[!t]
	\begin{center}
		\subfloat{
			\includegraphics[width=0.8\textwidth]{prot_teff_Santos19_Santos21_clean0.pdf}
		}
		\vspace{-0.62cm}
		\subfloat{
			\includegraphics[width=0.66\textwidth]{koi_mean_prot_teff.pdf}
		}
	\end{center}
	\vspace{-0.5cm}
	\caption{
