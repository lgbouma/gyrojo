...
\begin{figure}[!t]
  \begin{center}
    \leavevmode
    \includegraphics[width=0.48\textwidth]{li_vs_teff_koi_X_JUMP_eagles_logy.pdf}
  \end{center}
  \vspace{-0.6cm}
  \caption{
...
\begin{figure*}[!p]
  \begin{center}
    \leavevmode
    \subfloat{
    \includegraphics[width=\textwidth]{comp_hist_samples_koi_gyro_ages_hist_field_gyro_ages_20240430_maxage4000.pdf}
    }

	\vspace{-0.3cm}
    \subfloat{
    \includegraphics[width=\textwidth]{comp_hist_samples_koi_gyro_ages_hist_field_gyro_ages_20240430_maxage4000_preciseagesonly.pdf}
    }
  \end{center}
  \vspace{-0.6cm}
  \caption{
...
\begin{figure*}[!t]
  \begin{center}
    \includegraphics[width=0.85\textwidth]{rp_vs_period_scatter_20240415_colorbyage_showaux-gyro_anyyoung_anyyoung.pdf}
  \end{center}
  \vspace{-0.5cm}
  \caption{
...
narrowly-constrained age range, confidence in the true age
increases, because the two techniques are independent.
The region of greatest overlap between rotation and lithium ages in
the spaces of $P_{\rm rot}$, EW$_{\rm Li}$, and $T_{\rm eff}$ is
dictated by the timescale for lithium depletion: for stars with
temperatures between 4500-5500\,K with ages $\lesssim$500\,Myr, we can
hope to obtain independent two-sided constraints
\citep{Bouma_2023,Jeffries_2023}.

The following systems, to our knowledge, are being
...
mentioned above.
{\bf FIXME TODO: next two paragraphs are boring.  come up with a better way to do this,
and maybe automate}
...
though at half the relative uncertainty.  This system may be the
youngest Earth-sized planet currently known, comparable to systems
...
Most ages reported in this study come from a single source of information: rotation.
Factors other than stellar age and mass can influence rotation rates of main sequence stars.
Binarity is the best example of this: even intermediate-separation ($\sim$10\,AU) binaries are biased
toward rotating anomalously
rapidly
\citep{Meibom_2007,2016AJ....152..115S,2019ApJ...871..174S,Gillen_2020,Bouma_2021}.
...
age distribution of the Kepler field, but also in the reliability of ages for
individual young planet hosting stars.
The quality flagging scheme in Table~\ref{tab:planets} provides one method in support of
this end.
...
constraining lithium age (\kepseveneightsix\,Myr) and no rotation age.
...
\citep{2008ApJ...687.1264M,2014MNRAS.441.2361V,2024ApJ...960...62E}.
...
In the ``old star'' regime, methods that use both the evolution of
