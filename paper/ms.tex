...
them from the main sequence.  For 0.1--1\,Gyr stars that are on
...
\begin{figure*}[!t]
    ...
    described in Section~\ref{subsec:plflags}.  The number of planets $N_{\rm p}$
    and number of stars $N_{\rm s}$ are noted in each panel.
