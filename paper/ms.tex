...
\citet{McQuillan_2014} (see Appendix~\ref{app:reinhold23}).  We found
...
\citetalias{Santos_2021} rotation period catalogs, the more recent
...
(i.e.~all Kepler stars), and considered a novel period measurement
approach based on gradients of power spectra (GPS).  Their method
