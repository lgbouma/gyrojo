...
% <250 words
\begin{abstract}
  Recent studies of FGK stars in open clusters have quantitatively
  shown how stellar rotation rates and lithium content evolve over
  the first few billion years.
  %
  Here we apply this knowledge to stars observed by Kepler to compute
  ...
  than isochrone ages in our sample of FGK stars.
  %
  ...
  for both planet hosts as well as for the overall stellar sample.
  %
  ...
  balance of young and old planets detectable through
  transit surveys of nearby stars in the thin disk.
  %
\end{abstract}
...
stellar metallicity and mass \citep{Petigura_2018}, at levels likely
...
plotting purposes if the 1$\sigma$ lower limit on the equivalent width
is below 10\,m\AA.  Our measured
...
ages for these systems of \kepsixsixtgyro\ and \kepsixseventgyro\ for
...
of stars this hot are relatively slow after the first gigayear.
