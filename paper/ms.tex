...
Owing to the success of the transit and radial velocity techniques,
exoplanet science is going through an age of abundance in which we are
beginning to explore thousands of new worlds that orbit in close
proximity to their host stars.
However, most of these exoplanets are old, with ages comparable to
that of the solar system.
This limits our ability to understand their origins, and in particular
to study processes such as dynamical migration (CITE), thermal cooling
(CITE), and atmospheric loss (CITE) that typically happen soon after
disk dispersal.
Finding and characterizing young ($<$1\,Gyr) exoplanets is one way to
advance our understanding of how and when these processes occur.
...
and therefore measurements of the \ion{Li}{1} 6708\,\AA\ doublet, in
...
Figure~\ref{fig:models} exemplifies this problem, particularly in
...
%		}
	...
	\caption{
		...
		Planets highlighted in this plot have $t$<1\,Gyr at $2$$\sigma$.
%		
