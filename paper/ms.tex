...
\begin{abstract}
  ...
  ages using rotation and lithium.
  %
  ...
  $\approx$15-20$\times$ more precise than isochrone ages in our
  sample of FGK stars.
  %
  The independent lithium age estimates agree with the rotation-based
  ages for $\approx$90\% of stars.  However, the timescales of lithium
  depletion are such that rotation-based ages are more precise for
  most of our stellar sample.
  %
...
\begin{enumerate}
  ...
  \item Analyzing the age distributions of both the Kepler
    ...
    %TODO: quote uncertainty on this number.
  %
