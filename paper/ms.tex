...
\begin{abstract}
  ...
  mission to curate catalogs of rotation and lithium-based ages.
  %
  ...
  %
  While the independent lithium ages are consistent with XX\% of the rotation ages,
  this method is significantly less precise than rotation-based age dating
  ...
  %
  In the broader sample of stars in the Kepler field, we find that the
  rotation-based age distribution decreases linearly from 3\,Gyr ago
  to present day, implying a linearly decreasing star formation rate.
  %
