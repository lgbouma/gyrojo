...
\begin{abstract}
  ...
  mission to calculate rotation and lithium-based ages.
  %
  ...
  than isochrone-based ages for our sample of FGK stars.
  %
  The independent lithium ages are consistent for XX\% of cases;
  however this method is less precise than rotation-based age dating
