...
utility of a planet, and assemble them into a separate bit-flag,
$Q_{\rm planet}$.
...
Kepler is near unity up to $\approx$3\,Gyr, and it
...
The stellar ages and planetary
properties of all of these systems are given in
...
the cases for which lithium
and rotation overlap in sensitivity -- G and K dwarfs with $t$$\lesssim$1\,Gyr.  Our results
