...
\begin{abstract}
  ...
  %
  The independent lithium ages show X,Y,Z, though they are subject to
  their own systematic issues.
  %
...
system.
This fact leaves many gaps in our knowledge of what exact dynamical
and physical processes produce these objects.
...
$\approx$1\,Gyr timescales in a way that can leave observable imprints in
