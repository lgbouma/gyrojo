...
spanned -3.9 to -1.2 for the K dwarfs,
...
due to the variability of their host stars requires some
nuance.  If true, this statement only holds for the very youngest
stars, where we see a marginal deficit in the KOI host age
distribution relative to that of the overall stellar sample.
However at the age resolution of this study, 
this selection bias against sub-gigayear planets seems small. 
