...
\section{The Preferred Rotation Period Catalog}
\label{app:reinhold23}

While we opted for the 
...
similar selection function as \citeauthor{Santos_2021}, and
...
the GPS method is a few times less precise than 
