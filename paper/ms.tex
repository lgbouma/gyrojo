...
\begin{abstract}
  ...
  for stars and planets observed by the primary Kepler mission.
  Stellar rotation periods are collected from previous analyses of the
  Kepler light curves; lithium content is assessed using HIRES
  spectra.
  ...
  that the gyrochronal age distribution rises roughly linearly from
  0-3\,Gyr, with stars 2\,Gyr old being twice as common in the Kepler
  field as stars 1\,Gyr old.
  This qualitatively agrees with results from previous isochronal and
  asteroseismic studies, though it extends their sensitivity down to
  $\approx$0.1\,Gyr.
  The sample of detected Kepler planets has a similar age distribution, though
  it is slightly deficient at $\lesssim$0.2\,Gyr, likely due to
  decreased detection sensitivity.
  %TODO will this be the case?
  We also comment on a
