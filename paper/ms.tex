...
Focusing only on the tails of the distributions (0-0.3\,Gyr and
2.7-3\,Gyr), the implication is that the formation rate of stars in
the Kepler field decreased by a factor of \ratiosfr$\pm$\uncratiosfr\
...
The fact that only $\approx$90\% of the rotation-based and
lithium-based ages agree 

While hopefully clear from our extensive use of quality flags, 
