...
500 grid points, and interpolated the resulting posteriors to determine
point estimate summary statistics.
At the old end, 
\texttt{gyro-interp} is calibrated out
to 4\,Gyr M67 cluster
\citep[see][]{Dungee_2022,Gruner_2023}.  
...
\citep{Amard2019}, since it showed better agreement with
...
stars $\gtrsim$1\,Gyr old, available literature ages of sub-gigayear stars are
usually overestimated by 0.3--2\,dex.  
The ages of the youngest Kepler stars and planets were not previously well-measured.
For isochrone and kinematic ages, this is because these
methods rely on parameters that do not appreciably change at
$t$$\lesssim$1\,Gyr.  For the rotation-based ages from
\citet{2023ApJ...952..131M} and \citet{2024AJ....167..159L}, the
discrepancy is
caused by details of the calibration methodologies.  The
spin-down models used in these studies
may struggle to reproduce the observed rotation
sequences seen in open clusters younger than a few hundred million years.  The \citet{Mamajek_2008}
calibration used by \citet{Reinhold_2015} does fit such
sequences for Sun-like stars.  However the
uncertainties from all of these methods are underestimated because
