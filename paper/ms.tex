...
\begin{abstract}
  ...
  primary Kepler mission, and calculate the implied rotation and
  lithium-based ages.
  %
  ...
  1\,Gyr old.
  %
  This parent stellar age distribution bounds the relative balance of
  young and old planets detectable not only by Kepler, but also by
