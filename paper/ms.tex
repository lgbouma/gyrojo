...
We used this sampling approach, rather than taking a histogram of
only the median values, because it better captures the asymmetric posteriors
of the youngest stars.
We also considered an alternative approach for constructing these
plots using hierarchical Bayesian deconvolution \citep{Masuda2022infer}, and found similar results.
The plotted uncertainties assume Poisson statistics.  We truncated the plots
...
shows that outliers do exist, typically $\lesssim$10\% of the population
...
\citep{vanSaders_2016,2024ApJ...962..138S}, or else that use both the
