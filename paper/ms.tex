...
%  the technique may be compromised.
  ...
  %
  This approach offers greater sensitivity to main sequence ages than previous analyses of the Milky Way's star
  formation history, and the resulting age distribution bounds
  the relative balance of ``young'' and ``old'' planets detectable not only by Kepler, but also
  by future wide-field transit surveys.
  %
