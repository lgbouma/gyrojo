...
based on membership in RSG-5 \citep{Bouma_2022}.  }
...
\begin{figure}[!t]
    ...
    from Keck/HIRES spectra collected between 2010 and 2024.}
...
\begin{deluxetable}{lllrrrr}
	...
	%\endhead
	\startdata
	KOI & Kepler & $t_{\rm gyro}$ & $R_{\rm p}$ & $P_{\rm orb}$ & $f_{\rm RUWE}$ & $f_{\rm grazing}$ \\
