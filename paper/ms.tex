...
\begin{abstract}
  ...
  previous analyses of the Kepler light curves; lithium is assessed directly from HIRES
  spectra.
  wWe report ages for \nkoisgoldwithages\ FGK stars with transiting planets, with relative statistical
  precisions $\sigma_t / t$ of XX +YY -ZZ\%; a factor of X.X
...
\citet{Santos2019} and \citet{Santos2021}, which for these cases
