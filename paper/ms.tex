...
\section{Regarding The Preferred Rotation Period Catalog}
\label{app:reinhold23}

While we opted for our default stellar rotation periods to be those
reported by \citetalias{Santos_2019} and \citetalias{Santos_2021},
the more recent analysis by \citet{Reinhold2023} bears comment.  \citet{Reinhold2023} used a
similar selection function as \citetauthor{Santos_2021}, and
considered a novel period measurement approach based on gradients of
power spectra (GPS).
Their method likely provides greater completeness, due
to its greater sensitivity to signals that are only weakly periodic.
However,
 comparing 
overlapping stars from
\citet{McQuillan_2014}, \citetalias{Santos_2019},
\citetalias{Santos_2021}, and \citet{Reinhold2023} suggested that for
stellar signals that are strongly periodic, 
the GPS method is likely a factor of a few times less precise than 
the more traditional approaches (ACF, Lomb-Scargle, or wavelet
analysis).

{\bf TODO: finish writing!}
{\bf TODO: finish writing!}
{\bf TODO: finish writing!}

%TODO: how many "new rotatoin periods" would this reinhold catalog
%yield?
%TODO: maybe you should just report ages for them!!
