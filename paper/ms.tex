...
\begin{enumerate}
  \item Two-sided posteriors available for both $t_{\rm gyro}$ and
    $t_{\rm Li}$: then if their values were consistent within
...
\item If $t_{\rm Li}$ is a lower limit, we compare the 3$\sigma$
...
\item If $t_{\rm Li}$ provides a two-sided posterior, and no rotation
  ...
  This is because such constraints can only be provided for G and K
...
\fracconsistentminageltonegyr\ of these ages are
...
\minageltonegyrnoconsistent\ discrepant cases in detail.
