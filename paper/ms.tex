...
secure for the subsets that are either in clusters, or that have
independent rotation and lithium-based ages.
...
Highlights from these systems include Kepler-1529, Kepler-1565,
...
Survey.  The surveys with good coverage of different regions of the
Galaxy seem most likely to yield new insight into whether the star
formation history we see in the Kepler field is universal across the
thin disk.
...
We are grateful to Kento Masuda for thought-provoking discussions 
which significantly influenced our thinking about this analysis.
