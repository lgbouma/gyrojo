...
\begin{figure*}[!t]
	\begin{center}
		\leavevmode
		\includegraphics[width=0.9\textwidth]{hist_samples_koi_gyro_ages_hist_field_gyro_ages_20230529_maxage3200.pdf}
	\end{center}
	\vspace{-0.6cm}
	\caption{
...
\begin{deluxetable}{lllrrrr}
	...
	%\endhead
	\startdata
	KOI & Kepler & $t_{\rm gyro}$ & $R_{\rm p}$ & $P$ & $f_{\rm RUWE}$ & $f_{\rm grazing}$ \\
	-- &   -- & Myr &    Earths &    days &      bool &   bool  \\
	\hline
