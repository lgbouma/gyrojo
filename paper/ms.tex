...
% <250 words
\begin{abstract}
  Recent studies of the rotation rates and lithium content of FGK
  stars in open clusters have revealed how these quantities evolve
  during the first few billion years of a star's life.
  %
  Here we apply this knowledge to stars observed by Kepler in order to
  derive rotation and lithium-based ages.
  %
  ...
  %
  The independent lithium and rotation-based ages agree for
  $\approx$90\% of stars.  However, the timescales of lithium
  depletion are such that rotation is the more precise age diagnostic
  for the majority of our stellar sample.
  %
  ...
  %
  More broadly, we find that the age distribution of stars in the
  Kepler field decreases linearly from 3\,Gyr ago to present day,
  for both known planet hosts as well as the parent stellar sample.
  %
  While this stellar age distribution has implications for the
...
\begin{figure*}[!t]
  ...
  \caption{
    ...
    Completeness is near unity until $\approx$3\,Gyr
