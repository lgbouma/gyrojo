...
uncertainties determined using that method are underestimates because
...
The age distributions of Kepler stars and planet hosts are quite
similar.  A simple diagnostic of whether the two
...
range of $\log_{\rm 10}p$-values (2.5$^{\rm th}$ to 97.5$^{\rm th}$ percentile)
spanned -3.9 to -1.2 for the K-dwarfs only,
and -5.2 to -2.2 for all Kepler stars.  This degree of similarity suggests that
...
% compare against Berger+20, note their sentence
...
periods of the most restricted set of planets are shown in
...
\appendix
\section{Defining An ``Isochronally Too Far From The Main Sequence'' Boundary}
